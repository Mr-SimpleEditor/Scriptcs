...
echo " ${Y} NOTE : Now your mono is installed which is automated for exectution of C#, script named as scriptcs. Now you can execute you file from anywhere, You can use vscode also without any problem"
